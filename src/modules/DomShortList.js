...
function editShortForm(index) {
  ...
  let shortTitle = document.getElementById('shortTitleForm');
  let shortDescription = document.getElementById('shortDescForm');
  let shortPriority = document.getElementById('shortPriorityForm');
  let shortDate = document.getElementById('shortDateForm');
...
function handleSubmitEditShort() {
  ...
  const editedItem = new TodoListShort(shortTitle, shortDescription, shortPriority, shortDate);
